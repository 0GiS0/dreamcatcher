...
<template>
  ...
  <div v-else>
    <div class="mb-8 text-center">
      <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">DreamCatcher</h1>
      <p class="mt-4 text-lg text-gray-600">Un diario personal de sueños donde puedes registrar tus sueños cada noche y descubrir patrones recurrentes</p>
